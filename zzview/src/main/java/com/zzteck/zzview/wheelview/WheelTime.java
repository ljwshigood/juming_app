...
import com.zzteck.zzview.R;
import com.zzteck.zzview.wheelview.adapter.NumericWheelAdapter;
import com.zzteck.zzview.wheelview.lib.WheelView;
...
public class WheelTime
{
	...
	private TimePickerView.OnTimeScrollLstener mTimeScrollListener ;

	public TimePickerView.OnTimeScrollLstener getmTimeScrollListener() {
		return mTimeScrollListener;
	}

	public void setmTimeScrollListener(TimePickerView.OnTimeScrollLstener mTimeScrollListener) {
		this.mTimeScrollListener = mTimeScrollListener;
	}
		...
		OnItemSelectedListener wheelListener_year = new OnItemSelectedListener()
		{
			...
			public void onItemSelected(int index)
			{
				...
				try {
					...
					if(mTimeScrollListener != null){
						mTimeScrollListener.onTimeScroll(date) ;
					}
