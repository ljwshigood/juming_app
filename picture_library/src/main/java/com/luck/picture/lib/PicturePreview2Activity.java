...
import com.luck.picture.lib.adapter.SimpleFragment2Adapter;
 ...
 * data：16/12/31
 */
public class PicturePreview2Activity extends PictureBaseActivity implements
        View.OnClickListener, Animation.AnimationListener, SimpleFragment2Adapter.OnCallBackActivity {
    ...
    private SimpleFragment2Adapter adapter;
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.picture_preview_two);
    ...
    private void initViewPageAdapterData() {
        tv_title.setText(position + 1 + "/" + images.size());
        adapter = new SimpleFragment2Adapter(images, this, this);
