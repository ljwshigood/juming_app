...
public class Recommand2Adapter extends RecyclerArrayAdapter<HomeInfo.DataBean> {
    ...
    public Recommand2Adapter(Context context, List<HomeInfo.DataBean> objects) {
    ...
    public class RecommandViewHolder extends BaseViewHolder<HomeInfo.DataBean> {
        ...
        public RecommandViewHolder(ViewGroup parent) {
            super(parent, R.layout.item_recommand_two);
