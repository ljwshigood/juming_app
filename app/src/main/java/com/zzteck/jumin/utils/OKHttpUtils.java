...
public class OKHttpUtils {
     ...
     * @return
     */
    private static Request getRequest(String url, List<String> fileNames,String cname,String idc,String sign) {
        Request.Builder builder = new Request.Builder();
        builder.url(url)
                .post(getRequestBody(fileNames,cname,idc,sign))
     ...
     * @return
     */
    private static Request getRequest(String url, List<String> fileNames, ProgressListener uiProgressRequestListener,String cname,String idc,String sign) {
        Request.Builder builder = new Request.Builder();
        builder.url(url)
                .post(ProgressHelper.addProgressRequestListener(
                        OKHttpUtils.getRequestBody(fileNames,cname,idc,sign),
     ...
     */
    public static void doPostRequest(String url, List<String> fileNames, ProgressListener uiProgressRequestListener, Callback callback,String cname,String idc,String sign) {
        Call call = getOkHttpClientInstance().newCall(getRequest(url, fileNames, uiProgressRequestListener,cname,idc,sign));
     ...
     * @param callback  OkHttp的回调接口
     */
    public static void doPostRequest(String url, List<String> fileNames, Callback callback,String cname,String idc,String sign) {
        Call call = getOkHttpClientInstance().newCall(getRequest(url, fileNames,cname,idc,sign));
        call.enqueue(callback);
    }
